...
#' @keywords FreeList
#' @return The value returned is a data frame, where each row represents a subject, and each column represents one of your free list Codes. Depending on "tabeType" the entries of the dataframe will either represent a frequency/ absence of salience table.
