...
#' @usage SalienceZOIB(data, var_sel, variables, top, threshold, print_model = TRUE, seed, chains = 4, iterations = 2000, warmup = 1000, cores = 4, priors, IDs_first = TRUE)
...
#' @param top The number of variables to perform ZOIB model on (i.e., the x variables with the highest Smith's S values; default = 8). Only to be used when var_sel = "TOP".
#' @param threshold The minimum Smith's S threshold for inclusion in the ZOIB model process (default = 0.1). Only to be used when var_sel = "THRESH".
