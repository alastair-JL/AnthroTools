...
#'  check that the ratio of the first and second factor when determining competance is over three, and as such these numbers are reported by the programe.
...
#' 
#' @references 
#' Weller, S. (2007) Cultural Consensus Theory:Applications and Frequently Asked Questions  \s\s    
...
#' Anders, R. 2014 "CCTPack: Cultural Consensus TheoryApplications to Data" R package Version 1.4.     \s\s
#'  Romney, A. K., Weller, S. C., & Batchelder, W. H. (1986). Culture as Consensus: A Theory of Culture and Informant Accuracy. American Anthropologist, 88(2), 313-338.   \s\s
