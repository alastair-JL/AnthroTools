...
#'  the ratio of the first and second eigenvalue when determining competance. If possible, more analytically justifiable methods
#'  will be developed to better detect when the method of consensus analysis is or isn't appropriate for a given dataset.
#'  
...
#'  
#'  If anyone reading this takes an interest in these concerns, or has encountered a paper address them, we would 
#'  love to hear from you- and use any further discoveries to futher improve the code, such that all may use.
#'  
